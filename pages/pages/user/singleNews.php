                                    ...
                                    <div class="card mb-1">
                                        ...
                                        <div class="card-footer">
                                            <div class="float-end gap-2">
                                                ...
                                                ?>
                                                    <button class="btn btn-primary read-more" data-user="<?= $user_id ?>" type="button" id="btnReadMore<?= $comment->id ?>" data-bs-toggle="collapse" data-bs-target="#comment<?= $comment->id ?>" aria-expanded="false" aria-controls="comment<?= $comment->id ?>" data-comment="<?= $comment->id ?>">
                                                        Show more
                                                    </button>
                                                <?php endif; ?>
                                                <?php
