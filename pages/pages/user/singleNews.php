            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <?php endif; ?>
                        <?php
                        if (getOneFetchAndCheckData('comments', 'id_post', $post->id, 'check') != 0) :
                                        ...
                                        <div class="card mb-1">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="gap-3 d-flex">
                                                    <button class="btn btn-transparent d-flex vote-action" data-action="likes" data-post="<?= $post->id ?>" data-comment="<?= $comment->id ?>" <?php if (!isset($_SESSION['user'])) : ?> disabled <?php endif; ?>>
                                            ...
                                            <div class="card-footer">
                                                <div class="float-end gap-2">
                                                    <button class="btn btn-outline-primary read-more" id="comment_<?= $comment->id ?>" data-post="<?= $post->id ?>" data-comment="<?= $comment->id ?>" data-bs-toggle="collapse" data-bs-target="#comment<?= $comment->id ?>" aria-="false" aria-controls="comment<?= $comment->id ?>">
                                                        Load more</button>
