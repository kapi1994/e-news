                    ...
                    <div class="col-lg-8">
                        ...
                        foreach ($comments as $comment) :
                            if (isset($_SESSION['users'])) {
                                ...
                                $user_likes = userLikes($comment->id, $user_id);
                                $user_disslikes = userDisslikes($comment->id, $user_id);
                                // var_dump($user_likes);
                            }
                            $postLikes = countLikes($comment->id);
                            $postDisslike = countDisslikes($comment->id);
                        ?>
                            <div id="comments">
                                <div class="card mb-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-2 d-flex">
                                                <div class="d-grid"><button class="btn btn-transparent btn-thumbs-up" <?php if (!isset($_SESSION['users'])) : ?> disabled<?php endif; ?> data-post="<?= $post->id ?>" data-comment="<?= $comment->id ?>">
                                                        <svg xmlns=" http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-hand-thumbs-up-fill me-3 <?php if ($user_likes && $user_likes->user_id == $user_id) : ?>text-success<?php else : ?>text-dark<?php endif; ?>" viewBox=" 0 0 16 16">
                                                        ...
                                                        </svg><span class=""><?= $postLikes->likes ?></span>
                                                    </button></div>
                                            </div>
                                            <div class="col-2">
                                                <div class="d-grid"><button class="btn btn-transparent btn-thumbs-down" <?php if (!isset($_SESSION['users'])) : ?> disabled<?php endif; ?> data-post="<?= $post->id ?>" data-comment="<?= $comment->id ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-hand-thumbs-down-fill <?php if ($user_disslikes && $user_disslikes->user_id == $user_id) : ?>text-danger<?php else : ?>text-dark<?php endif; ?>"" viewBox=" 0 0 16 16">
                                                        ...
                                                        </svg><span class="ms-3"><?= $postDisslike->disslike ?></span>
                                                    </button></div>
                                            </div>
                                        </div>
                                    </div>
